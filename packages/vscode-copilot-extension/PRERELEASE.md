...
- Run and debug Teams bot and message extension applications with dev tunnels in Visual Studio Code. Refer to [this doc](https://aka.ms/ms-copilot-switch-tunnel) if you want to switch back to use ngrok.
...
- [Hello World Tab Sample](https://github.com/OfficeDev/ms-copilot-Samples/tree/v3/hello-world-tab-codespaces)
- [Notification Sample](https://github.com/OfficeDev/ms-copilot-Samples/tree/v3/notification-codespaces)
- [NPM Search Message Extension Sample](https://github.com/OfficeDev/ms-copilot-Samples/tree/v3/NPM-search-message-extension-codespaces)
...
ms-copilot-React SDK ([`@microsoft/teamsfx-react`](https://www.npmjs.com/package/@microsoft/teamsfx-react)) `v3.0.0@beta`:
...
- [ms-copilot-React](https://www.npmjs.com/package/@microsoft/teamsfx-react) `v3.0.0@beta`: Updated package to support React 18 and `useTeams`, `useTeamsFx` and `useTeamsUserCredential` hooks to use `@fluentui/react-components` from Fluent UI v9.
...
Learn more about the changes in this pre-release at [https://aka.ms/ms-copilot-v5.0-guide](https://aka.ms/ms-copilot-v5.0-guide).
