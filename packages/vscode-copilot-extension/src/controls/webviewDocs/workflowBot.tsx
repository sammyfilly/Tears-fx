  ...
  return (
    <div className="markdown-body">
      ...
      <blockquote>
        ...
        <p>
          ...
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-command-response#customize-installation"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
          .
      ...
      <ul>
        <li>
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-card-action-response#customize-the-action-response"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-card-action-response#customize-the-adaptive-card-content"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-card-action-response#auto-refresh-to-user-specific-view"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-card-action-response#access-microsoft-graph"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-card-action-response#connect-to-existing-apis"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-card-action-response#customize-the-initialization"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
      ...
      <p>
        ...
        <ExternalLink
          title="steps here"
          link="https://aka.ms/ms-copilot-card-action-response#how-to-extend-workflow-bot-with-notification-feature"
          triggerFrom={TelemetryTriggerFrom.InProductDoc}
          docName={name}
        />{" "}
