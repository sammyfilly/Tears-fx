  ...
  return (
    <div className="markdown-body">
      ...
      <blockquote>
        ...
        <p>
          ...
          <ExternalLink
            ...
            link="https://aka.ms/ms-copilot-notification#customize-installation"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
          .
      ...
      <div className="collapsibleSteps">
        ...
        >
          ...
          <p>
            ...
            <ExternalLink
              title="sample"
              link="https://aka.ms/ms-copilot-adaptive-card-sample"
              triggerFrom={TelemetryTriggerFrom.InProductDoc}
              docName={name}
            />{" "}
        ...
        >
          ...
          <ul>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#send-notifications-to-a-channel"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#send-notifications-to-a-group-chat"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#send-notifications-to-a-personal-chat"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
          ...
          <ul>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#send-notifications-to-a-specific-channel"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#send-notifications-to-a-specific-person"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
          ...
          <p>
            ...
            <ExternalLink
              ...
              link="https://aka.ms/ms-copilot-notification"
              triggerFrom={TelemetryTriggerFrom.InProductDoc}
              docName={name}
            />
          ...
          <ul>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#customize-storage"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#customize-adapter"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#customize-initialization"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#add-authentication-for-your-notification-api"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#connect-to-existing-api"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
            <li>
              <ExternalLink
                ...
                link="https://aka.ms/ms-copilot-notification#frequently-asked-questions"
                triggerFrom={TelemetryTriggerFrom.InProductDoc}
                docName={name}
              />
            </li>
      ...
      <p>
        ...
        <ExternalLink
          title="steps here"
          link="https://aka.ms/ms-copilot-command-response#How-to-add-more-command-and-response"
          triggerFrom={TelemetryTriggerFrom.InProductDoc}
          docName={name}
        />{" "}
        ...
        <ExternalLink
          ...
          link="https://aka.ms/ms-copilot-command-response"
          triggerFrom={TelemetryTriggerFrom.InProductDoc}
          docName={name}
        />{" "}
      ...
      <p>
        ...
        <ExternalLink
          title="steps here"
          link="https://aka.ms/ms-copilot-card-action-response#add-more-card-actions"
          triggerFrom={TelemetryTriggerFrom.InProductDoc}
          docName={name}
        />{" "}
        ...
        <ExternalLink
          ...
          link="https://aka.ms/ms-copilot-card-action-response"
          triggerFrom={TelemetryTriggerFrom.InProductDoc}
          docName={name}
        />{" "}
        for more information.
      ...
      <ul>
        <li>
          <ExternalLink
            ...
            link="https://docs.microsoft.com/microsoftteams/platform/toolkit/ms-copilot-multi-env"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://docs.microsoft.com/microsoftteams/platform/toolkit/ms-copilot-collaboration"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        ...
        <li>
          <ExternalLink
            ...
            link="https://docs.microsoft.com/microsoftteams/platform/toolkit/ms-copilot-cli"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            title="TeamsFx SDK"
            link="https://docs.microsoft.com/microsoftteams/platform/toolkit/ms-copilot-sdk"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
        <li>
          <ExternalLink
            ...
            link="https://github.com/OfficeDev/ms-copilot-Samples"
            triggerFrom={TelemetryTriggerFrom.InProductDoc}
            docName={name}
          />
        </li>
