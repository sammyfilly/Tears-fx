...
export function activate(): Result<Void, FxError> {
  ...
  try {
    ...
    tools = {
      ...
      treeProvider: TreeViewManagerInstance.getTreeView("ms-copilot-accounts")!,
      ui: VS_CODE_UI,
...
export function detectVsCodeEnv(): VsCodeEnv {
  ...
  const extension = vscode.extensions.getExtension("TeamsDevApp.ms-copilot-vscode-extension");
...
export async function openDocumentHandler(args?: any[]): Promise<Result<boolean, FxError>> {
  ...
  let url = "https://aka.ms/ms-copilot-build-first-app";
...
export async function openAccountLinkHandler(args: any[]): Promise<boolean> {
  ...
  return env.openExternal(Uri.parse("https://aka.ms/ms-copilot-treeview-account"));
}
...
export async function openEnvLinkHandler(args: any[]): Promise<boolean> {
  ...
  return env.openExternal(Uri.parse("https://aka.ms/ms-copilot-treeview-environment"));
}
...
export async function openDevelopmentLinkHandler(args: any[]): Promise<boolean> {
  ...
  return env.openExternal(Uri.parse("https://aka.ms/ms-copilot-treeview-development"));
}
...
export async function openLifecycleLinkHandler(args: any[]): Promise<boolean> {
  ...
  return env.openExternal(Uri.parse("https://aka.ms/ms-copilot-treeview-deployment"));
}
...
export async function openHelpFeedbackLinkHandler(args: any[]): Promise<boolean> {
  ...
  return env.openExternal(Uri.parse("https://aka.ms/ms-copilot-treeview-helpnfeedback"));
}
export async function openWelcomeHandler(args?: any[]): Promise<Result<unknown, FxError>> {
  ...
  const data = await vscode.commands.executeCommand(
    ...
    "TeamsDevApp.ms-copilot-vscode-extension#teamsToolkitGetStarted"
  );
...
async function showLocalDebugMessage() {
  ...
  if (isWindows) {
    ...
    const openFolderCommand = `command:ms-copilot-extension.openFolder?%5B%22${folderLink}%22%5D`;
    message = util.format(
...
export function registerAccountMenuCommands(context: ExtensionContext) {
  ...
  context.subscriptions.push(
    commands.registerCommand("ms-copilot-extension.signOut", async (node: TreeViewCommand) => {
      try {
...
export async function signInAzure() {
  vscode.commands.executeCommand("ms-copilot-extension.signinAzure");
}

export async function signInM365() {
  vscode.commands.executeCommand("ms-copilot-extension.signinM365");
}
...
export async function openLifecycleTreeview(args?: any[]) {
  ...
  if (globalVariables.isTeamsFxProject) {
    vscode.commands.executeCommand("ms-copilot-lifecycle.focus");
  } else {
...
export async function selectTutorialsHandler(args?: any[]): Promise<Result<unknown, FxError>> {
      ...
      ? [
          {
            ...
            data: "https://aka.ms/ms-copilot-add-cicd-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
                command: "ms-copilot-extension.openTutorial",
              },
            ],
          },
        ]
      : [
          {
            ...
            data: "https://aka.ms/ms-copilot-workflow-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.scenario"),
            data: "https://aka.ms/ms-copilot-notification-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.scenario"),
            data: "https://aka.ms/ms-copilot-command-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.scenario"),
            data: "https://aka.ms/ms-copilot-dashboard-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            data: "https://aka.ms/ms-copilot-add-tab",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.capability"),
            data: "https://aka.ms/ms-copilot-add-bot",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.capability"),
            data: "https://aka.ms/ms-copilot-add-message-extension",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          ...[
            {
              ...
              groupName: localize("teamstoolkit.guide.capability"),
              data: "https://aka.ms/ms-copilot-add-outlook-add-in",
              buttons: [
                {
                  iconPath: "file-symlink-file",
                  tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          ],
          {
            ...
            groupName: localize("teamstoolkit.guide.development"),
            data: "https://aka.ms/ms-copilot-add-sso-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.development"),
            data: "https://aka.ms/ms-copilot-add-api-connection-new",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.development"),
            data: "https://aka.ms/ms-copilot-mobile",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.development"),
            data: "https://aka.ms/ms-copilot-multi-tenant",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            data: "https://aka.ms/ms-copilot-add-azure-function",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.cloudServiceIntegration"),
            data: "https://aka.ms/ms-copilot-add-azure-sql",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.cloudServiceIntegration"),
            data: "https://aka.ms/ms-copilot-add-azure-apim",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
          ...
          },
          {
            ...
            groupName: localize("teamstoolkit.guide.cloudServiceIntegration"),
            data: "https://aka.ms/ms-copilot-add-azure-keyvault",
            buttons: [
              {
                iconPath: "file-symlink-file",
                tooltip: localize("teamstoolkit.guide.tooltip.github"),
  ...
  if (TreatmentVariableValue.inProductDoc && !globalVariables.isSPFxProject) {
    (config.options as StaticOptions).splice(0, 1, {
      ...
      detail: localize("teamstoolkit.guides.cardActionResponse.detail"),
      groupName: localize("teamstoolkit.guide.scenario"),
      data: "https://aka.ms/ms-copilot-card-action-response",
      buttons: [
        {
          iconPath: "file-code",
  ...
  switch (node.contextValue) {
    case "signinM365": {
      await vscode.commands.executeCommand("workbench.action.openWalkthrough", {
        category: "TeamsDevApp.ms-copilot-vscode-extension#teamsToolkitGetStarted",
        step: "TeamsDevApp.ms-copilot-vscode-extension#teamsToolkitGetStarted#teamsToolkitCreateFreeAccount",
      });
    ...
    case "ms-copilot-extension.create":
    case "ms-copilot-extension.openSamples": {
      return VS_CODE_UI.openUrl("https://aka.ms/ms-copilot-create-project");
    }
    case "ms-copilot-extension.provision": {
      return VS_CODE_UI.openUrl("https://aka.ms/ms-copilot-provision-cloud-resource");
    }
    case "ms-copilot-extension.build": {
      return VS_CODE_UI.openUrl("https://aka.ms/teams-store-validation");
    }
    case "ms-copilot-extension.deploy": {
      return VS_CODE_UI.openUrl("https://aka.ms/ms-copilot-deploy");
    }
    case "ms-copilot-extension.publish": {
      return VS_CODE_UI.openUrl("https://aka.ms/ms-copilot-publish");
    }
    case "ms-copilot-extension.publishInDeveloperPortal": {
