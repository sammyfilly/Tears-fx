...
export const m365AppsPrerequisitesHelpLink = "https://aka.ms/ms-copilot-m365-apps-prerequisites";
...
export const openOutputDisplayMessage = () =>
  util.format(
    ...
    `[${localize(
      "teamstoolkit.localDebug.outputPanel"
    )}](command:ms-copilot-extension.showOutputChannel)`
  );
...
export const prerequisiteCheckForGetStartedDisplayMessages: DisplayMessages = {
  ...
  learnMoreHelpLink: "https://aka.ms/ms-copilot-get-started-prerequisite",
  ...
  errorHelpLink: "https://aka.ms/ms-copilot-get-started-prerequisite",
...
export const v3PrerequisiteCheckTaskDisplayMessages: DisplayMessages = {
  ...
  learnMoreHelpLink: "https://aka.ms/ms-copilot-tasks/check-prerequisites",
  errorName: ExtensionErrors.PrerequisitesValidationError,
  ...
  showDetailMessage: openOutputMessage,
  showDetailDisplayMessage: openOutputDisplayMessage,
  errorHelpLink: "https://aka.ms/ms-copilot-tasks/check-prerequisites",
  durationMessage: (duration: number) =>
...
export const baseTunnelDisplayMessages = Object.freeze({
  ...
  learnMoreHelpLink: "https://aka.ms/ms-copilot-local-tunnel-task",
