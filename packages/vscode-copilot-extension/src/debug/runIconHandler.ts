...
function enableRunIcon(): void {
  ...
  vscode.commands.executeCommand("setContext", "ms-copilot-extension.runIconActive", validProject);
}

export function disableRunIcon(): void {
  vscode.commands.executeCommand("setContext", "ms-copilot-extension.runIconActive", false);
}
